...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Connect with trusted local services and get it done." },
      { name: "author", content: "Zovio" },
      { property: "og:title", content: "Zovio | Connect. Get It Done." },
      { property: "og:description", content: "Connect with trusted local services and get it done." },
